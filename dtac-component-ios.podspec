...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "CHAKRIT PANIAM" => "Chakrit69@gmail.com" }
  # Or just: spec.author    = "CHAKRIT PANIAM"
  # spec.authors            = { "CHAKRIT PANIAM" => "Chakrit69@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/CHAKRIT PANIAM"
