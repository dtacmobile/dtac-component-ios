//
//  dtacPrimaryButtonOutline.swift
//  component
//
...
@IBDesignable class dtacPrimaryButtonOutline: UIButton {
    ...
    func setSelected() {
        ...
        self.layer.borderColor = DtacColor.primaryTelenorLink.cgColor
        self.backgroundColor = DtacColor.graysWhite
        self.titleLabel?.font = UIFont.bodyBold
        self.setTitleColor(DtacColor.primaryTelenorLink, for: .normal)
    }
